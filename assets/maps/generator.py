...
visited_places = [
    ...
    {"city": "Falerna Marina", "lat": 39.0492, "lon": 16.3994, "description": "International Conference on Pervasive Intelligence and Computing (PICom 2022)"},
...
fig = px.scatter_geo(
    ...
    size_max=25,  # Maximum size of the markers
